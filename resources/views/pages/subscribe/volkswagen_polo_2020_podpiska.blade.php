...
@section('content')
    ...
    <article>
        ...
        <p>Арендовать новый Volkswagen Polo по подписке &ndash; это возможность получить новый автомобиль в отличной комплектации и без забот о сопутствующем техническом обслуживании, страховках, налогах. Все это берет на себя компания Офис «Казанский»!</p>

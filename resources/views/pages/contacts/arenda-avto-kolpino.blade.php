...
@section('title')
    Аренда авто в Колпино
@endsection

@section('content')
    <div itemscope="" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs"><span itemscope="" itemprop="itemListElement" class="B_firstCrumb" itemtype="http://schema.org/ListItem"><a itemprop="item" href="/"><span itemprop="name">Главная</span><meta itemprop="position" content="1"></a></span><span class="sep">»</span><a href="/kontakty/">Контакты</a><span class='sep'>»</span><span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><link href="/kontakty/arenda-avto-kolpino/" itemprop="url item"><span itemprop="name" class='current'>Колпино</span><meta itemprop="position" content="2"></span></div>
    <div class="toph1"><h1>Аренда авто в Колпино</h1></div>
    <div class="contInfoPage">
        <div class="sliderMap">
            <div class="owl-carousel">
                <img class="imgloader" src="/images/contacts/car_tr.png" data-src="/images/contacts/kolpino_550_auto_jpg.jpg" alt="" title="" decoding="async" />
            </div>
        </div>
    ...
    <script>
        ymaps.ready(function () {
            ...
            var map = new ymaps.Map('map', {
                center: [59.8747214,28.5232146,9],
                zoom: 14,
            ...
            /*
            ymaps.geocode([59.8747214,28.5232146,9], { kind: 'metro' }).then(function (res) {
                var nearest = res.geoObjects.get(0);
                //var name = nearest.properties.get('name');
                var m = nearest.geometry.getCoordinates();

                ymaps.route([
                    [59.8747214,28.5232146,9],
                    m
                ], {
                    //multiRoute: true,
                ...
                myPlacemark = new ymaps.Placemark([59.8747214,28.5232146,9], {

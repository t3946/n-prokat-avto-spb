...
@section('title')
    Аренда авто в Мурино
@endsection

@section('content')

    <div itemscope="" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs"><span itemscope="" itemprop="itemListElement" class="B_firstCrumb" itemtype="http://schema.org/ListItem"><a itemprop="item" href="/"><span itemprop="name">Главная</span><meta itemprop="position" content="1"></a></span><span class="sep">»</span><a href="/kontakty/">Контакты</a><span class='sep'>»</span><span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><link href="/kontakty/arenda-avto-murino/" itemprop="url item"><span itemprop="name" class='current'>Мурино</span><meta itemprop="position" content="2"></span></div>
    <div class="toph1"><h1>Аренда авто в Мурино</h1></div>
    <div class="contInfoPage">
        <div class="sliderMap">
            <div class="owl-carousel">
                <img class="imgloader" src="/images/contacts/car_tr.png" data-src="/images/contacts/murino_550_auto_jpg.jpg" alt="" title="" decoding="async" />
            </div>
        </div>
        <div class="mainInfoCont">
            <h2>Контактная информация</h2>
            <ul class="ulcont">
                <li><span class="icoimg"><img src="/images/contacts/icons/map@3x.png" alt="" /></span><span>Мурино</span></li>
    ...
    <script>
        ymaps.ready(function () {
            ...
            var map = new ymaps.Map('map', {
                center: [59.8908259,29.079292,13],
                zoom: 14,
            ...
            /*
            ymaps.geocode([59.8908259,29.079292,13], { kind: 'metro' }).then(function (res) {
                var nearest = res.geoObjects.get(0);
                //var name = nearest.properties.get('name');
                var m = nearest.geometry.getCoordinates();

                ymaps.route([
                    [59.8908259,29.079292,13],
                    m
                ], {
                    //multiRoute: true,
                ...
                myPlacemark = new ymaps.Placemark([59.8908259,29.079292,13], {

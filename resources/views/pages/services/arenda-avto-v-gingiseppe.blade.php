...
@section('content')
    ...
    <article class="innerPageContent">
        <h2>Офис «Казанский»: аренда современных минивэнов на любой срок</h2>
        ...
        <p>Мы следим за чистотой и внешним видом нашего автопарка. Всегда чистые, без неприятного запаха, обработанные после каждого арендатора эффективным антисептиком, автомобили из Офис «Казанский» &nbsp;безопасны, комфортны и просто красивы.</p>
        ...
        <h2>Концепция сервиса Офис «Казанский»: каждый клиент- уникален</h2>
        ...
        <ul>
            <li>время за счет мобильного приложения Офис «Казанский»;</li>
        ...
        <p>Арендуйте минивэн без водителя в Офис «Казанский» на сутки, неделю, месяц &ndash; мы сделаем все, чтобы вы остались довольны!</p>
    </article>

...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <p>Все машины из автопарка Офис «Васнецовский» прошли техническое обслуживание, полностью исправны, застрахованы по КАСКО и ОСАГО, снабжены кондиционером и другим функционалом. В основном используется автоматическая коробка передач, так что водить будет удобно. После каждого арендатора мы проводим тщательную очистку и дезинфекцию салона.</p>

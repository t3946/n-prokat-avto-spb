...
@section('content')
    ...
    <article class="innerPageContent">
        <h2>Прокат элитных авто в &laquo;Альмак Прокат&raquo;</h2>
        <p>Инфинити, Мерседес, БМВ, Генезис из автопарка компании &laquo;Альмак Прокат&raquo; &ndash; легендарные марки машин последних лет выпуска. Можно взять в аренду люксовое вип-авто без водителя на любой срок &ndash; от нескольких часов до нескольких месяцев.</p>
        ...
        <p>Мы ценим время и удобство наших клиентов, поэтому разработали мобильное приложение &laquo;Альмак Прокат&raquo;.</p>
        ...
        <p>Позвольте себе автомобиль мечты. Хотя бы на короткое время. Арендуйте машину&nbsp;бизнес-класса в &laquo;Альмак Прокат&raquo;! Вы этого достойны.</p>
    </article>

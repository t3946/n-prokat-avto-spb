...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <p>Компания &laquo;Альмак Прокат&raquo; уже много лет работает в сфере проката и располагает собственным автопарком из машин бизнес-класса, премиум, люкс, эконом, а также коммерческим транспортом, минивэнами и внедорожниками. Весь автотраеспорт:</p>
        <ul>

...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <h2>Как происходит оформление аренды в Офис «Васнецовский»</h2>
        ...
        <p>Выбор и бронирование машины для помесячной аренды можно сделать за 2 минуты через бесплатное мобильное приложение Офис «Васнецовский». Оформление аренды машины на месяц потребует минимального набора документов и 15 минут.</p>
        ...
        <p>Услуги Офис «Васнецовский» - это выгодно, надежно и удобно.</p>
    </article>

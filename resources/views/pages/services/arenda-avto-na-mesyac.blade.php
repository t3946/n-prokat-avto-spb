...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <h2>Как происходит оформление аренды в &laquo;Альмак-Прокат&raquo;</h2>
        ...
        <p>Выбор и бронирование машины для помесячной аренды можно сделать за 2 минуты через бесплатное мобильное приложение &laquo;Альмак Прокат&raquo;. Оформление аренды машины на месяц потребует минимального набора документов и 15 минут.</p>
        ...
        <p>Услуги &laquo;Альмак Прокат&raquo; - это выгодно, надежно и удобно.</p>
    </article>

...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <p>Автоцентр &laquo;Альмак Прокат&raquo; объединяет в себе салон, банк и автосервис, то есть:</p>
        <ul>
        ...
        <p>Еще одно важное преимущество обращения в &laquo;Альмак Прокат&raquo; - возможность вернуть машину в любой момент без обязательств по погашению оставшейся задолженности. Вам не нужно будет самостоятельно выставлять машину на торги и встречаться с потенциальными покупателями.</p>
    </article>

...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <p>Подробные правила проката автомобиля на длительный срок уточняйте у наших специалистов по телефону, через сайт и при личной встрече. Также они помогут Вам выбрать лучший вариант по соотношению цены и желаемых характеристик и оформят документы. Сервис долгосрочной аренды авто &laquo;Альмак Прокат&raquo; работает уже много лет и потому гарантирует, что Вы получите все, что Вам нужно!</p>
    </article>

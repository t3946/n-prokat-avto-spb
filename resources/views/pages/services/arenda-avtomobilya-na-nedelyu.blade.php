...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <h2>Оформление аренды машины в &laquo;Альмак-Прокат&raquo;</h2>
        ...
        <p>Арендуйте автомашины на неделю по своему вкусу и предпочтениям в &laquo;Альмак-Прокат&raquo; &ndash; это выгодно, надежно и удобно!</p>
    </article>
@endsection

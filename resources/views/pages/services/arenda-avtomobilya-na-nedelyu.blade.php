...
@section('content')
    ...
    <article class="innerPageContent">
        ...
        <h2>Оформление аренды машины в Офис «Васнецовский»</h2>
        ...
        <p>Арендуйте автомашины на неделю по своему вкусу и предпочтениям в Офис «Васнецовский» &ndash; это выгодно, надежно и удобно!</p>
    </article>
@endsection

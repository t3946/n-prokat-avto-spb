...
@section('content')
    ...
    <article class="innerPageContent">
        <h2>Прокат элитных авто в Офис «Васнецовский»</h2>
        <p>Инфинити, Мерседес, БМВ, Генезис из автопарка компании Офис «Васнецовский» &ndash; легендарные марки машин последних лет выпуска. Можно взять в аренду люксовое вип-авто без водителя на любой срок &ndash; от нескольких часов до нескольких месяцев.</p>
        ...
        <p>Мы ценим время и удобство наших клиентов, поэтому разработали мобильное приложение Офис «Васнецовский».</p>
        ...
        <p>Позвольте себе автомобиль мечты. Хотя бы на короткое время. Арендуйте машину&nbsp;бизнес-класса в Офис «Васнецовский»! Вы этого достойны.</p>
    </article>

...
@section('content')
    ...
    <article class="innerPageContent">
        <h2>Годовая аренда в Офис «Казанский»</h2>
        ...
        <p>Компания Офис «Казанский» 7 лет успешно занимается прокатом автомобилей. Одними из первых мы стали предоставлять авто&nbsp;на длительный срок.</p>
        <p>Клиенты могут оформить в аренду на год новый автомобиль эконом, среднего, бизнес,&nbsp;представительского класса. Все авто прошли ТО в специализированных сервисных центрах, имеют страховые полисы КАСКО, ОСАГО. Выбрать и&nbsp;забронировать транспорт можно через бесплатное мобильное приложение Офис «Казанский».</p>
        ...
        <p>Офис «Казанский» предоставляет клиентам:</p>
        <ul>

...
@section('content')
    ...
    <article class="innerPageContent">
        <h2>Офис «Васнецовский»: аренда современных минивэнов на любой срок</h2>
        ...
        <p>Мы следим за чистотой и внешним видом нашего автопарка. Всегда чистые, без неприятного запаха, обработанные после каждого арендатора эффективным антисептиком, автомобили из Офис «Васнецовский» &nbsp;безопасны, комфортны и просто красивы.</p>
        ...
        <h2>Концепция сервиса Офис «Васнецовский»: каждый клиент- уникален</h2>
        ...
        <ul>
            <li>время за счет мобильного приложения Офис «Васнецовский»;</li>
        ...
        <p>Арендуйте минивэн без водителя в Офис «Васнецовский» на сутки, неделю, месяц &ndash; мы сделаем все, чтобы вы остались довольны!</p>
    </article>

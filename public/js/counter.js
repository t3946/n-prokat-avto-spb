...
function send_data_to_controller(data_string = '') {
    ...
    //
    // let path_to_counter = 'counter';
    // let url = document.location.protocol + '//' + document.location.hostname + '/' + path_to_counter  + '/counter.php';

    // xhr.open('POST', url, true);
    // xhr.setRequest   Header('Content-type', 'application/x-www-form-urlencoded');

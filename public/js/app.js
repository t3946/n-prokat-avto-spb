...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // const $ = require('./origin/jquery-3.1.1.min');
// window.jQuery = $;
// window.$ = $;
// require('./origin/alla');
// require('./origin/counter');
